...
Route::middleware('authToken')->post('/remove-bookmark', [BookController::class, 'removeBookmarkById']);
...
Route::post('delete-user-profile', [ProfileController::class, 'deleteUserProfile']);
